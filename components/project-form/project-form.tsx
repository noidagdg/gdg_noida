...
import { Check, ChevronLeft, ChevronRight, CircleAlert, Cpu, FileImage, LoaderCircle, MonitorCog, Rocket, ShoppingBag, Trash2 } from "lucide-react";
...
export function ProjectForm() {
  ...
  const values = useWatch<ProjectFormValues>({ control: form.control }) as ProjectFormValues;
